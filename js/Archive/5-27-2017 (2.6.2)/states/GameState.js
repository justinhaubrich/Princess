...
create: function() 
    {
        ...
        levelText = princessPersis.game.add.text(200, 44, "Level " +princessPersis.customParams.currentLevel, {fonstize: '32', fill: '#fff'});
        ...
        if (princessPersis.customParams.cursors.up.isDown && player.body.touching.down)
            {
                ...
                else (player.body.velocity.y = -300)
            }
          
            //Punch
            if (princessPersis.customParams.xKey.downDuration( 500) && princessPersis.customParams.playerLeft == false) 
                {
            ...
            else if (princessPersis.customParams.xKey.downDuration( 500) && princessPersis.customParams.playerLeft == true) 
                {
                //player.frame = 14;
