...
princessPersis.loadLevel = function (groundGroup)
{
    ...
    while (this.loadLevel.currentiValue <= this.numTilesWorldWidth) {
        ...
        if (floorOption == 1)
            ...
            princessPersis.loadLevel.placeFloor(1, groundGroup, 1, 15, true);
            floorToggle = true;
        ...
        else 
        {
            ...
            else
            {
                ...
                console.log('floor option 2b selected');
...
princessPersis.loadLevel.generateBrickFloor = function(iValue, iQuantity, groundGroup) 
{
...
princessPersis.loadLevel.placeFloor = function (floorOption, groundGroup, numberOne, numberTwo, booleanForXGap) 
{
    if (floorOption == 1) //place regular floor
        {
            if (booleanForXGap) 
            {
            princessPersis.loadLevel.generateBrickFloor(princessPersis.loadLevel.currentiValue + princessPersis.loadLevel.generateRandomNumber(0,1), princessPersis.loadLevel.generateRandomNumber(numberOne,numberTwo), groundGroup);
            }
            else
            {
