    ...
    function preload() {
        ...
        game.load.spritesheet('princess', 'Sprites/Princess_Sprite_Leftv3.png', 64, 64, 8);
    ...
    function update() {
       ...
       // if (timeCheck > game.time.now) {debugText.destroy()}; 
        ...
        if (Math.abs(distanceBetweenPlayer(player, testEnemy)) < 50.00) {debugText.setText('kill')}
        ...
        //else if (xKey.isDown) {player.frame = 7;}
