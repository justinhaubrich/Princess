    ...
    function preload() {
        ...
        game.load.spritesheet('princess', 'Sprites/Princess_Sprite_Leftv3.png', 64, 64, 21);
    ...
    /* Create Enemies */
        ...
        player.animations.add('punch', [15,13], 1, false);
        player.animations.add('punchLeft', [16,14], 5, false);
...
/*----------------------------------------------------------------------------------------------*/
    ...
    //update Text
        //debugText.setText(distanceBetweenPlayer(player, firstEnemy));
            ...
            debugText2.setText("firstEnemy.isAlive = " + firstEnemy.isAlive + ", isPlayerAlive = " + isPlayerAlive + ", isEnemyOnRight: " + isEnemyOnRightOfPlayer(player, secondEnemy) + secondEnemy.onRightOfPlayer);
    ...
    /*-----------------------------------------------------------------------------------------*/    
        ...
        if (cursors.left.isDown)
            {
                ...
                playerLeft = true;
                if (cursors.up.isDown == false) {player.animations.play('left', 5, true);}
        ...
        //Move Right
            ...
            {        
                ...
                playerLeft = false;
                if (cursors.up.isDown == false) {player.animations.play('right', 5, true);}
        ...
        if (cursors.up.isDown && player.body.touching.down)
            ...
            else if (xKey.justPressed(Phaser.Keyboard.X, 9000) && playerLeft == true) 
                {
                player.frame = 14;
                    //player.animations.play("punchLeft", 50, true);
                isPlayerPunching = true;
                    punchTime = game.time.now;
