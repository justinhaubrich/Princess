...
var game = new Phaser.Game(960, 640, Phaser.AUTO, 'gameDOM', { preload: preload, create: create, update: update });
    ...
    secondMonster.anchor.setTo(0.5, 0.5);
    ...
    function update() {
        ...
        function distanceBetweenPlayerY(player, enemy) {return player.body.x - enemy.body.x;}
    ...
    //update Text
        ...
        if (Math.abs(distanceBetweenPlayer(player, testEnemy)) < 50.00 && Math.abs(distanceBetweenPlayerY(player, testEnemy)) < 400.00)                     
            {
            isPlayerTouchingEnemy=true;debugText.setText('isPlayerTouchingEnemy=true')
            }
        else 
            {
            isPlayerTouchingEnemy=false;debugText.setText('isPlayerTouchingEnemy=false')
             }
