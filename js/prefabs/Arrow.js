...
{
    if (this.direction == -1 && Math.abs(this.body.velocity.x >200))
    {
        this.angle -= .2;
    }
    else if (this.direction == 1 && Math.abs(this.body.velocity.x >200))
    {
...
this.body.velocity.x = this.directionVelocity;
   ...
   //if (this.body.velocity.x >100) {princessPersis.game.physics.arcade.collide(this, princessPersis.GameState.brickSquare);}
...
//    //check overlap
//    if (checkOverlap(this,princessPersis.GameState.brickSquare)) 
//        {
//            this.body.velocity.x = 0;
//            this.body.gravity.y = 800;
//            console.log('ARROW OVERLAP WITH BRICK GROUP');
//        }
