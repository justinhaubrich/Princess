...
//scaler is breaking the game
//princessPersis.dimensions = princessPersis.getGameLandscapeDimensions(1280, 720);
...
princessPersis.game.state.start('HomeState');
     ...
     princessPersis.customParams = {
        ...
        inventory: {
         ...
         currentLevel:1,
         coins:0,
         playerTexture: 'princess',
         backgroundNumber: undefined,
        };
